...
int main() {
    ...
    while (window.isOpen()) {
        ...
        if (player.shape.getPosition().x < 0.0)
        {
        ...
        if (player.shape.getPosition().x + player.shape.getGlobalBounds().width > window.getSize().x)
        {
            player.shape.setPosition(window.getSize().x - player.shape.getGlobalBounds().width, player.shape.getPosition().y);
        }
        if (player.shape.getPosition().y + player.shape.getGlobalBounds().height > window.getSize().y)
        {
