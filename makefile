...
link: 
	g++ main.o equipaggiamento.o personaggio.o npc.o aiutante.o casino.o medico.o quiz.o nemico.o mercante.o casella.o menu.o arma.o pozione.o giocatore.o gioco.o -o main -Lsrc/lib -lsfml-graphics -lsfml-window -lsfml-system